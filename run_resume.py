...
Uses xhtml2pdf for better HTML rendering quality
"""

import sys

from html2pdf_generator import generate_pdf_with_xhtml2pdf
from web_renderer import pdf_to_images, run_web_server


def main():
    """Main function to generate PDF and start web server"""

    print("=== HTML-to-PDF Resume Generator & Web Renderer ===")
    print()

    try:
        # Step 1: Generate PDF from HTML
        print("📄 Generating PDF resume from HTML/CSS...")
        pdf_path = generate_pdf_with_xhtml2pdf("resume.pdf")
        ...
        print("   Features:")
        print("   - High-quality HTML-rendered PDF")
        print("   - Matches original HTML/CSS design")
